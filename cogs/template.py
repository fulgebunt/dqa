...
#name=name of cog
class General(commands.Cog, name="template"):

    #Initiate cog
    def __init__(self, bot):
        self.bot = bot

    #Name and desc of command
    ...
    #type = any input
    @app_commands.describe(type="chance")
    async def chance(self, context: Context,  dungeon: str="none", type: str="none", pot: str="none") -> None:
        #yourcode starts
        bases = {
            "wo": {
                "l": [1092, 1208]
        ...
        prob = calc_prob(dungeon, type, pot)
        drops = "1 in " + str(1 / prob) + " drops"
        if type == "l" and dungeon == "nlu" or type == "l" and dungeon == "gsu":
            runs = "1 in " + str(1 / prob * 13875 / 7) + " runs\n"
        elif type == "l" and dungeon == "nl" or type == "l" and dungeon == "gs":
            runs = "1 in " + str(1 / prob * 555) + " runs\n"
        elif type == "l":
            runs = "1 in " + str(1 / prob * 1000 / 3) + " runs\n"
        elif type == "c":
            runs = "1 in " + str(1 / prob * 3 / 0.00117 / 2) + " runs\n"
        #yourcode ends
        embed = discord.Embed(
        ...
        #Anything you wanna add, use embed.add_field
        #Inline=True means it will try to show the fields on the same line
        embed.add_field(
            name=drops,
            value=runs,
            inline=False
